...
public class march extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strfeb1 = prefsfeb.getString("strmarch","");
        txt.setText(strfeb1);
        String strfeb2 = prefsfeb.getString("strmarch2","");
        txt2.setText(strfeb2);
        String strfeb3 = prefsfeb.getString("strmarch3","");
        txt3.setText(strfeb3);
        String str4 = prefsfeb.getString("strmarch4","");
        txt4.setText(str4);
        String str5 = prefsfeb.getString("strmarch5","");
        txt5.setText(str5);
        String str6 = prefsfeb.getString("strmarch6","");
        txt6.setText(str6);
        String str7 = prefsfeb.getString("strmarch7","");
        txt7.setText(str7);
        String str8 = prefsfeb.getString("strmarch8","");
        txt8.setText(str8);
        String str9 = prefsfeb.getString("strmarch9","");
        txt9.setText(str9);
        String str10 = prefsfeb.getString("strmarch10","");
        txt10.setText(str10);
        String str11 = prefsfeb.getString("strmarch11","");
        txt11.setText(str11);
        String str12 = prefsfeb.getString("strmarch12","");
        txt12.setText(str12);
        String str13 = prefsfeb.getString("strmarch13","");
        txt13.setText(str13);
        String str14 = prefsfeb.getString("strmarch14","");
        txt14.setText(str14);
        String str15 = prefsfeb.getString("strmarch15","");
        txt15.setText(str15);
        String str16 = prefsfeb.getString("strmarch16","");
        txt16.setText(str16);
        String str17 = prefsfeb.getString("strmarch17","");
        txt17.setText(str17);
        String str18 = prefsfeb.getString("strmarch18","");
        txt18.setText(str18);
        String str19 = prefsfeb.getString("strmarch19","");
        txt19.setText(str19);
        String str20 = prefsfeb.getString("strmarch20","");
        txt20.setText(str20);
        String str21 = prefsfeb.getString("strmarch21","");
        txt21.setText(str21);
        String str22 = prefsfeb.getString("strmarch22","");
        txt22.setText(str22);
        String str23 = prefsfeb.getString("strmarch23","");
        txt23.setText(str23);
        String str24 = prefsfeb.getString("strmarch24","");
        txt24.setText(str24);
        String str25 = prefsfeb.getString("strmarch25","");
        txt25.setText(str25);
        String str26 = prefsfeb.getString("strmarch26","");
        txt26.setText(str26);
        String str27 = prefsfeb.getString("strmarch27","");
        txt27.setText(str27);
        String str28 = prefsfeb.getString("strmarch28","");
        txt28.setText(str28);
        String str29 = prefsfeb.getString("strmarch29","");
        txt29.setText(str29);
        String str30 = prefsfeb.getString("strmarch30","");
        txt30.setText(str30);
        String str31 = prefsfeb.getString("strmarch31","");
        txt31.setText(str31);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Toast.makeText(march.this,"Saved", Toast.LENGTH_SHORT).show();
                //To save data
                SharedPreferences prefsfeb = PreferenceManager.getDefaultSharedPreferences(march.this);
                SharedPreferences.Editor editor = prefsfeb.edit();

                str2 = txt.getText().toString();
                editor.putString("strmarch",str2);

                str2 = txt2.getText().toString();
                editor.putString("strmarch2",str2);
                str2 = txt3.getText().toString();
                editor.putString("strmarch3",str2);
                str2 = txt4.getText().toString();
                editor.putString("strmarch4",str2);
                str2 = txt5.getText().toString();
                editor.putString("strmarch5",str2);
                str2 = txt6.getText().toString();
                editor.putString("strmarch6",str2);
                str2 = txt7.getText().toString();
                editor.putString("strmarch7",str2);
                str2 = txt8.getText().toString();
                editor.putString("strmarch8",str2);
                str2 = txt9.getText().toString();
                editor.putString("strmarch9",str2);
                str2 = txt10.getText().toString();
                editor.putString("strmarch10",str2);
                str2 = txt11.getText().toString();
                editor.putString("strmarch11",str2);
                str2 = txt12.getText().toString();
                editor.putString("strmarch12",str2);
                str2 = txt13.getText().toString();
                editor.putString("strmarch13",str2);
                str2 = txt14.getText().toString();
                editor.putString("strmarch14",str2);
                str2 = txt15.getText().toString();
                editor.putString("strmarch15",str2);
                str2 = txt16.getText().toString();
                editor.putString("strmarch16",str2);
                str2 = txt17.getText().toString();
                editor.putString("strmarch17",str2);
                str2 = txt18.getText().toString();
                editor.putString("strmarch18",str2);
                str2 = txt19.getText().toString();
                editor.putString("strmarch19",str2);
                str2 = txt20.getText().toString();
                editor.putString("strmarch20",str2);
                str2 = txt21.getText().toString();
                editor.putString("strmarch21",str2);
                str2 = txt22.getText().toString();
                editor.putString("strmarch22",str2);
                str2 = txt23.getText().toString();
                editor.putString("strmarch23",str2);
                str2 = txt24.getText().toString();
                editor.putString("strmarch24",str2);
                str2 = txt25.getText().toString();
                editor.putString("strmarch25",str2);
                str2 = txt26.getText().toString();
                editor.putString("strmarch26",str2);
                str2 = txt27.getText().toString();
                editor.putString("strmarch27",str2);
                str2 = txt28.getText().toString();
                editor.putString("strmarch28",str2);
                str2 = txt29.getText().toString();
                editor.putString("strmarch29",str2);
                str2 = txt30.getText().toString();
                editor.putString("strmarch30",str2);
                str2 = txt31.getText().toString();
                editor.putString("strmarch31",str2);
