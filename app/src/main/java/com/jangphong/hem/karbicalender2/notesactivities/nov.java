...
public class nov extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strfeb1 = prefsfeb.getString("strnov","");
        txt.setText(strfeb1);
        String strfeb2 = prefsfeb.getString("strnov2","");
        txt2.setText(strfeb2);
        String strfeb3 = prefsfeb.getString("strnov3","");
        txt3.setText(strfeb3);
        String str4 = prefsfeb.getString("strnov4","");
        txt4.setText(str4);
        String str5 = prefsfeb.getString("strnov5","");
        txt5.setText(str5);
        String str6 = prefsfeb.getString("strnov6","");
        txt6.setText(str6);
        String str7 = prefsfeb.getString("strnov7","");
        txt7.setText(str7);
        String str8 = prefsfeb.getString("strnov8","");
        txt8.setText(str8);
        String str9 = prefsfeb.getString("strnov9","");
        txt9.setText(str9);
        String str10 = prefsfeb.getString("strnov10","");
        txt10.setText(str10);
        String str11 = prefsfeb.getString("strnov11","");
        txt11.setText(str11);
        String str12 = prefsfeb.getString("strnov12","");
        txt12.setText(str12);
        String str13 = prefsfeb.getString("strnov13","");
        txt13.setText(str13);
        String str14 = prefsfeb.getString("strnov14","");
        txt14.setText(str14);
        String str15 = prefsfeb.getString("strnov15","");
        txt15.setText(str15);
        String str16 = prefsfeb.getString("strnov16","");
        txt16.setText(str16);
        String str17 = prefsfeb.getString("strnov17","");
        txt17.setText(str17);
        String str18 = prefsfeb.getString("strnov18","");
        txt18.setText(str18);
        String str19 = prefsfeb.getString("strnov19","");
        txt19.setText(str19);
        String str20 = prefsfeb.getString("strnov20","");
        txt20.setText(str20);
        String str21 = prefsfeb.getString("strnov21","");
        txt21.setText(str21);
        String str22 = prefsfeb.getString("strnov22","");
        txt22.setText(str22);
        String str23 = prefsfeb.getString("strnov23","");
        txt23.setText(str23);
        String str24 = prefsfeb.getString("strnov24","");
        txt24.setText(str24);
        String str25 = prefsfeb.getString("strnov25","");
        txt25.setText(str25);
        String str26 = prefsfeb.getString("strnov26","");
        txt26.setText(str26);
        String str27 = prefsfeb.getString("strnov27","");
        txt27.setText(str27);
        String str28 = prefsfeb.getString("strnov28","");
        txt28.setText(str28);
        String str29 = prefsfeb.getString("strnov29","");
        txt29.setText(str29);
        String str30 = prefsfeb.getString("strnov30","");
        txt30.setText(str30);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Toast.makeText(nov.this,"Saved", Toast.LENGTH_SHORT).show();
                //To save data
                SharedPreferences prefsfeb = PreferenceManager.getDefaultSharedPreferences(nov.this);
                SharedPreferences.Editor editor = prefsfeb.edit();

                str2 = txt.getText().toString();
                editor.putString("strnov",str2);

                str2 = txt2.getText().toString();
                editor.putString("strnov2",str2);
                str2 = txt3.getText().toString();
                editor.putString("strnov3",str2);
                str2 = txt4.getText().toString();
                editor.putString("strnov4",str2);
                str2 = txt5.getText().toString();
                editor.putString("strnov5",str2);
                str2 = txt6.getText().toString();
                editor.putString("strnov6",str2);
                str2 = txt7.getText().toString();
                editor.putString("strnov7",str2);
                str2 = txt8.getText().toString();
                editor.putString("strnov8",str2);
                str2 = txt9.getText().toString();
                editor.putString("strnov9",str2);
                str2 = txt10.getText().toString();
                editor.putString("strnov10",str2);
                str2 = txt11.getText().toString();
                editor.putString("strnov11",str2);
                str2 = txt12.getText().toString();
                editor.putString("strnov12",str2);
                str2 = txt13.getText().toString();
                editor.putString("strnov13",str2);
                str2 = txt14.getText().toString();
                editor.putString("strnov14",str2);
                str2 = txt15.getText().toString();
                editor.putString("strnov15",str2);
                str2 = txt16.getText().toString();
                editor.putString("strnov16",str2);
                str2 = txt17.getText().toString();
                editor.putString("strnov17",str2);
                str2 = txt18.getText().toString();
                editor.putString("strnov18",str2);
                str2 = txt19.getText().toString();
                editor.putString("strnov19",str2);
                str2 = txt20.getText().toString();
                editor.putString("strnov20",str2);
                str2 = txt21.getText().toString();
                editor.putString("strnov21",str2);
                str2 = txt22.getText().toString();
                editor.putString("strnov22",str2);
                str2 = txt23.getText().toString();
                editor.putString("strnov23",str2);
                str2 = txt24.getText().toString();
                editor.putString("strnov24",str2);
                str2 = txt25.getText().toString();
                editor.putString("strnov25",str2);
                str2 = txt26.getText().toString();
                editor.putString("strnov26",str2);
                str2 = txt27.getText().toString();
                editor.putString("strnov27",str2);
                str2 = txt28.getText().toString();
                editor.putString("strnov28",str2);
                str2 = txt29.getText().toString();
                editor.putString("strnov29",str2);
                str2 = txt30.getText().toString();
                editor.putString("strnov30",str2);
