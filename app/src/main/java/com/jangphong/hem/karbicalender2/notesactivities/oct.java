...
public class oct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strfeb1 = prefsfeb.getString("stroct","");
        txt.setText(strfeb1);
        String strfeb2 = prefsfeb.getString("stroct2","");
        txt2.setText(strfeb2);
        String strfeb3 = prefsfeb.getString("stroct3","");
        txt3.setText(strfeb3);
        String str4 = prefsfeb.getString("stroct4","");
        txt4.setText(str4);
        String str5 = prefsfeb.getString("stroct5","");
        txt5.setText(str5);
        String str6 = prefsfeb.getString("stroct6","");
        txt6.setText(str6);
        String str7 = prefsfeb.getString("stroct7","");
        txt7.setText(str7);
        String str8 = prefsfeb.getString("stroct8","");
        txt8.setText(str8);
        String str9 = prefsfeb.getString("stroct9","");
        txt9.setText(str9);
        String str10 = prefsfeb.getString("stroct10","");
        txt10.setText(str10);
        String str11 = prefsfeb.getString("stroct11","");
        txt11.setText(str11);
        String str12 = prefsfeb.getString("stroct12","");
        txt12.setText(str12);
        String str13 = prefsfeb.getString("stroct13","");
        txt13.setText(str13);
        String str14 = prefsfeb.getString("stroct14","");
        txt14.setText(str14);
        String str15 = prefsfeb.getString("stroct15","");
        txt15.setText(str15);
        String str16 = prefsfeb.getString("stroct16","");
        txt16.setText(str16);
        String str17 = prefsfeb.getString("stroct17","");
        txt17.setText(str17);
        String str18 = prefsfeb.getString("stroct18","");
        txt18.setText(str18);
        String str19 = prefsfeb.getString("stroct19","");
        txt19.setText(str19);
        String str20 = prefsfeb.getString("stroct20","");
        txt20.setText(str20);
        String str21 = prefsfeb.getString("stroct21","");
        txt21.setText(str21);
        String str22 = prefsfeb.getString("stroct22","");
        txt22.setText(str22);
        String str23 = prefsfeb.getString("stroct23","");
        txt23.setText(str23);
        String str24 = prefsfeb.getString("stroct24","");
        txt24.setText(str24);
        String str25 = prefsfeb.getString("stroct25","");
        txt25.setText(str25);
        String str26 = prefsfeb.getString("stroct26","");
        txt26.setText(str26);
        String str27 = prefsfeb.getString("stroct27","");
        txt27.setText(str27);
        String str28 = prefsfeb.getString("stroct28","");
        txt28.setText(str28);
        String str29 = prefsfeb.getString("stroct29","");
        txt29.setText(str29);
        String str30 = prefsfeb.getString("stroct30","");
        txt30.setText(str30);
        String str31 = prefsfeb.getString("stroct31","");
        txt31.setText(str31);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                editor.putString("stroct",str2);

                str2 = txt2.getText().toString();
                editor.putString("stroct2",str2);
                str2 = txt3.getText().toString();
                editor.putString("stroct3",str2);
                str2 = txt4.getText().toString();
                editor.putString("stroct4",str2);
                str2 = txt5.getText().toString();
                editor.putString("stroct5",str2);
                str2 = txt6.getText().toString();
                editor.putString("stroct6",str2);
                str2 = txt7.getText().toString();
                editor.putString("stroct7",str2);
                str2 = txt8.getText().toString();
                editor.putString("stroct8",str2);
                str2 = txt9.getText().toString();
                editor.putString("stroct9",str2);
                str2 = txt10.getText().toString();
                editor.putString("stroct10",str2);
                str2 = txt11.getText().toString();
                editor.putString("stroct11",str2);
                str2 = txt12.getText().toString();
                editor.putString("stroct12",str2);
                str2 = txt13.getText().toString();
                editor.putString("stroct13",str2);
                str2 = txt14.getText().toString();
                editor.putString("stroct14",str2);
                str2 = txt15.getText().toString();
                editor.putString("stroct15",str2);
                str2 = txt16.getText().toString();
                editor.putString("stroct16",str2);
                str2 = txt17.getText().toString();
                editor.putString("stroct17",str2);
                str2 = txt18.getText().toString();
                editor.putString("stroct18",str2);
                str2 = txt19.getText().toString();
                editor.putString("stroct19",str2);
                str2 = txt20.getText().toString();
                editor.putString("stroct20",str2);
                str2 = txt21.getText().toString();
                editor.putString("stroct21",str2);
                str2 = txt22.getText().toString();
                editor.putString("stroct22",str2);
                str2 = txt23.getText().toString();
                editor.putString("stroct23",str2);
                str2 = txt24.getText().toString();
                editor.putString("stroct24",str2);
                str2 = txt25.getText().toString();
                editor.putString("stroct25",str2);
                str2 = txt26.getText().toString();
                editor.putString("stroct26",str2);
                str2 = txt27.getText().toString();
                editor.putString("stroct27",str2);
                str2 = txt28.getText().toString();
                editor.putString("stroct28",str2);
                str2 = txt29.getText().toString();
                editor.putString("stroct29",str2);
                str2 = txt30.getText().toString();
                editor.putString("stroct30",str2);
                str2 = txt31.getText().toString();
                editor.putString("stroct31",str2);
